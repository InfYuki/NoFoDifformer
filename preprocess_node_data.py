...
def generate_node_data(dataset):
    ...
    if dataset in ['cora', 'citeseer','pubmed']:
        ...
        data = np.load('node_raw_data/amazon_electronics_photo/amazon_electronics_photo.npz', allow_pickle=True)
        ...
        edge_df = pd.read_csv('node_raw_data/{}/raw/'.format(dataset) + 'out1_graph_edges.txt', sep='\t')
        node_df = pd.read_csv('node_raw_data/{}/raw/'.format(dataset) + 'out1_node_feature_label.txt', sep='\t')
